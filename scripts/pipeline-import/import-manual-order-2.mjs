...
const PO_TITLE = 'Manual Order 2 - Sanitary fixtures';
const PO_NOTES = 'Imported from "Grandia - Iulian Orders (non-app)" sheet, tab "Order 2 - Sanitary". Manually-placed offline order. Costs sourced from product_pipeline_details (sheet had empty COGS/Transport columns).';
const PO_STATUS = 'DRAFT';
const PO_PRIORITY = 'STANDARD';
const CREATED_BY_ID = 2;

const ROOT = path.resolve(path.dirname(new URL(import.meta.url).pathname));
const PARSED = path.join(ROOT, 'data/manual-order-2-parsed.json');
