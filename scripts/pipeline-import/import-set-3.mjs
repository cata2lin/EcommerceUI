// Import Set 3 — same behavior as Set 1.1 / Set 2.
...
const TAB = 'Set 3';
const SLUG = 'set-3';
const PO_TITLE = 'Pipeline Set 3';
const PO_NOTES = 'Imported from Grandia Pipeline sheet on 2026-04-27. 72 ordered + 20 supplier-skipped.';
