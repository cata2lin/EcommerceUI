// Import Set 7 mix — splits into TWO POs:
//   - "Pipeline Set 7 mix - Confirmed" : green QTY rows
//   - "Pipeline Set 7 mix - Hold"      : non-green rows (qty kept as-is)
...
const POS = [
  {
    title: 'Pipeline Set 7 mix - Confirmed',
