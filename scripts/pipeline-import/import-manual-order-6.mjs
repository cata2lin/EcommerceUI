...
const PO_TITLE = 'Manual Order 6 - Green house';
const PO_NOTES = 'Imported from "Grandia - Iulian Orders (non-app)" sheet, tab "Order 6 - Green house". Costs from sheet (with DB fallback). 4 manually-added items without product IDs were skipped.';
const PO_STATUS = 'DRAFT';
const CREATED_BY_ID = 2;

const ROOT = path.resolve(path.dirname(new URL(import.meta.url).pathname));
const PARSED = path.join(ROOT, 'data/manual-order-6-parsed.json');
...
console.log(`=== Manual Order 6 — Green house ===`);
